...
//borrowed from SwimNodeEvaluator
    ...
    public BlockPathTypes getBlockPathType(BlockGetter blockaccessIn, int x, int y, int z) {
        ...
        if (fluidstate.isEmpty() && blockstate.isPathfindable(blockaccessIn, blockpos.below(), PathComputationType.WATER) && blockstate.isAir()) {
            ...
            return fluidstate.is(FluidTags.LAVA)  && blockstate.isPathfindable(blockaccessIn, blockpos, PathComputationType.WATER) ? BlockPathTypes.WATER : BlockPathTypes.BLOCKED;
        }
    }
    ...
    private Node getWaterNode(int p_186328_1_, int p_186328_2_, int p_186328_3_) {
        ...
        return pathnodetype != BlockPathTypes.BREACH  && pathnodetype != BlockPathTypes.LAVA ? null : this.getNode(p_186328_1_, p_186328_2_, p_186328_3_);
    }
